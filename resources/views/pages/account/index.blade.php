...
<section class="relative min-h-screen pt-32 pb-20">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-4 gap-4 mb-8">
            ...
            <a href="{{ route('account.info') }}" class="glass-strong rounded-2xl p-6 text-center hover:bg-white/[0.03] transition-all">
                <svg class="w-8 h-8 mx-auto text-orange-400 mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/></svg>
                <p class="text-white font-medium">Mes informations</p>
                <p class="text-heroi-text-muted text-sm">Mon profil</p>
            </a>
