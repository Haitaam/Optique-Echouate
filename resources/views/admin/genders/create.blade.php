...
@section('content')
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                <h1 class="text-2xl font-bold text-white">Ajouter un Genre</h1>
                <p class="text-heroi-text-muted text-sm mt-0.5">Nouveau genre de lunettes</p>
            </div>
        </div>

        <form method="POST" action="{{ route('admin.genders.store') }}" class="space-y-5">
            @csrf
